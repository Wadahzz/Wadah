...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(OsamaOpticV2.config.endpoints);
    var serviceConfig = $.extend(true, {}, OsamaOpticV2.config.services, {
        db: {
    ...
    OsamaOpticV2.db = new DevExpress.data.ODataContext(serviceConfig.db);
